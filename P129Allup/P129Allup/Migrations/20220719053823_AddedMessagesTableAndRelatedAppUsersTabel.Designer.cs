...
namespace P129Allup.Migrations
{
    ...
    [Migration("20220719053823_AddedMessagesTableAndRelatedAppUsersTabel")]
    partial class AddedMessagesTableAndRelatedAppUsersTabel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("P129Allup.Models.Color", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("P129Allup.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("P129Allup.Models.ProductColorSize", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("P129Allup.Models.Size", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("P129Allup.Models.Message", b =>
                {
                    b.HasOne("P129Allup.Models.AppUser", "Reciever")
                        .WithMany()
                        .HasForeignKey("RecieverId");

                    b.HasOne("P129Allup.Models.AppUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("P129Allup.Models.ProductColorSize", b =>
                {
                    b.HasOne("P129Allup.Models.Color", "Color")
                    ...
                    b.HasOne("P129Allup.Models.Size", "Size")
                        .WithMany("ProductColorSizes")
